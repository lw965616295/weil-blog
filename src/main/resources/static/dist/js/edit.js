...
$('#confirmButton').click(function () {
    ...
    if (!validLength(blogTags, 100000000)) {
        swal("文章内容过长", {
            icon: "error",
        });
        return;
...
$('#saveButton').click(function () {
    ...
    var swlMessage = '保存成功';
    var data = {
        "id": blogId, "title": blogTitle, "url": blogSubUrl, "categoryId": parseInt(blogCategoryId),
        "tags": blogTags, "content": blogContent, "coverImage": blogCoverImage, "status": parseInt(blogStatus),
        "enableComment": parseInt(enableComment)
    };
    console.log(data);
    $.ajax({
        type: 'POST',//方法类型
...
$('#randomCoverImage').click(function () {
    ...
    $("#blogCoverImage").attr("src", '/dist/img/rand/' + rand + ".jpg");
